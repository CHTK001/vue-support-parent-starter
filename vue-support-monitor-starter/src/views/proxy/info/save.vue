	...
	<el-dialog :title="title" v-model="visible" :width="700"  destroy-on-close @closed="$emit('closed')" draggable>
		<el-form :model="form" :rules="rules" :disabled="mode == 'show'" ref="dialogForm" label-width="100px" label-position="left">
			...
			<el-form-item label="代理名称" prop="proxyName">
				<el-input v-model="form.proxyName" clearable placeholder="请输入代理名称"></el-input>
			</el-form-item>

			<el-form-item label="代理地址" prop="proxy">
				<el-row>
					<el-col :span="12">
						<el-input v-model="form.proxyHost" placeholder="请输入代理地址"></el-input>
					</el-col>
					<el-col :span="12">
						<el-input v-model="form.proxyPort" type="number" placeholder="请输入代理端口"></el-input>
					</el-col>
				</el-row>
			</el-form-item>
			...
			<el-form-item label="说明" prop="proxyDesc">
				<el-input v-model="form.proxyDesc" clearable placeholder="请输入说明"></el-input>
			</el-form-item>
		...
		submit() {
			this.$refs.dialogForm.validate(async (valid) => {
				if (valid) {
					...
					this.isSaveing = true;
					if (this.mode === 'add') {
						res = await this.$API.proxy.save.post(this.form);
					} else if (this.mode === 'edit') {
						res = await this.$API.proxy.update.put(this.form);
					}
