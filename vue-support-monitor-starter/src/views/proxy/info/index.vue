                                ...
                                <el-card class="task task-item " shadow="always">
                                    <el-row class="relation">
                                        <el-col :span="12">
                                            <ul>
                                                ...
                                                <li>
                                                    <h4>代理说明</h4>
                                                    <p>
                                                        <el-tag effect="light" v-if="item.proxyDesc">{{ item.proxyDesc }}</el-tag>
                                        ...
                                        <el-col :span="12" class="cursor-pointer">
                                            <el-progress  type="circle"  :stroke-width="5" :percentage="100" :show-text="true">
                                                <template #default="{ percentage }">
                                                    <span class="percentage-value">{{ item.proxyPort }}</span>
                                                    <span class="percentage-label"><el-tag>{{ item.proxyProtocol }}</el-tag></span>
                                                </template>
                                            </el-progress>
                                        </el-col>
                                    </el-row>
