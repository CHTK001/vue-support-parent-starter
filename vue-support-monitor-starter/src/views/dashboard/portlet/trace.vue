    ...
    <el-dialog @close="onClose" :destroy-on-close="true" :show-close="false"
        ...
        <aYinTechBorderA1 style="height: 80vh;">
            ...
            <div ref="containerRef"
                ...
                <el-button type="danger" size="small" title="清除日志" icon="el-icon-delete" class="absolute"
                    style="border: 0; right: 10px; z-index: 20240229" circle @click="data.length = 0"></el-button>
                        ...
                        <techButtonB2 class="flex flex-wrap">
                            <div class="w-full max-w-full px-3 sm:flex-0 shrink-0">
                                <div style="padding-left: 20px; padding-right: 20px;"
                                    class="relative flex flex-col min-w-0  break-words  dark:bg-gray-950 shadow-soft-xl dark:shadow-soft-dark-xl  bg-clip-border">
                                    <div class="flex-auto">
                                        <span class="custom-tree-node" :title="data.message">
                                            ...
                                            @<span style="height: 26px;" v-time="data?.enterTimeMill"></span> 耗时:
                                            <span style="height: 26px;color: green; font-weight: 800;">{{ data?.costTime }} ms</span>
                                            <span>
