<template>
  <div class="h-full relative">
    ...
    <!-- <div class="absolute" style="top: 1%; left: 0%; z-index: 1">
      <el-button v-if="isOpen.value" class="sidebar-custom shadow" circle type="primary" :icon="useRenderIcon('ri:eye-2-fill')" @click="formatOpen(false)" />
...
//     },
//     getMessage(sql) {
//       return this.isOpen.value ? format(sql) : sql;
//     },
//     transformI18n,
//     useRenderIcon,
//     dateFormat
...
//   try {
//     dataList.unshift(JSON.parse(row?.data));
