 ...
 */
const exclude = ["@iconify-icons/ep", "@iconify-icons/ri", "@iconify-icons/meteocons", "@iconify-icons/line-md", "@iconify-icons/humbleicons", "@pureadmin/theme/dist/browser-utils"];
