...
import { fetchUpdateUser, fetchSaveUser } from "@/api/manage/user";
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="账号名称" prop="sysUserUsername">
              <el-input v-model="form.sysUserUsername" placeholder="请输入账号名称" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="用户昵称" prop="sysUserNickname">
              <el-input v-model="form.sysUserNickname" placeholder="请输入用户昵称" />
            </el-form-item>
          </el-col>
          ...
          <el-col :span="12">
            <el-form-item label="角色" prop="roleIds">
              <el-select v-model="form.roleIds" placeholder="请选择" class="w-full" clearable multiple>
                <el-option v-for="(item, index) in roleOptions" :key="index" :value="item.sysRoleId" :label="item.sysRoleName">
          ...
          <el-col :span="12">
            <el-form-item label="手机号" prop="sysUserPhone">
              <el-input v-model="form.sysUserPhone" placeholder="请输入手机号" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="24">
            <el-form-item label="备注" prop="sysUserRemark">
              <el-input v-model="form.sysUserRemark" placeholder="请输入备注" type="textarea" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
