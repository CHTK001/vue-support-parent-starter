<template>
    <el-button style="margin-left: 0px;" v-if="this.groupMap['device'] " 
    type="primary" size="small" icon="sc-icon-device" text plain @click="doDowload(item)" :title="this.groupMap['device']['desc']"></el-button>

    <el-button style="margin-left: 0px;" v-if="this.groupMap['org'] " 
