...
const getTagName = (tag: string) => {
  return env.serviceList?.find((item) => item.sysServiceId === tag)
    ?.sysServiceName;
};
          ...
          <div class="table-wrapper">
            ...
            >
              ...
              >
                <template #default="{ row }">
                  <div
                    v-if="row.sysTenantCorporation || row.sysTenantAddress"
                    class="company-cell"
                  >
                    <div v-if="row.sysTenantCorporation" class="company-name">
                      <IconifyIconOnline
                    ...
                    <div v-if="row.sysTenantAddress" class="company-address">
                      <IconifyIconOnline
