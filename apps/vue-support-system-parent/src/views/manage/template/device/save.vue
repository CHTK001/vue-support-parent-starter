...
import { message, getCameraRtspTemplates } from "@repo/utils";
            ...
            <el-col :span="24">
              <el-form-item label="设备类型" prop="sysDeviceResourceType">
                <el-select v-model="form.sysDeviceResourceType" placeholder="请选择设备类型" clearable class="w-full">
                  <el-option v-for="item in deviceResourceTypes" :key="item.sysDictItemCode"
                    :label="item.sysDictItemName" :value="item.sysDictItemCode">
            ...
            <el-col :span="24">
              <el-form-item label="推流地址" prop="sysDeviceRtsp">
                ...
                <el-select v-model="selectedRtspTemplate" placeholder="请选择摄像头厂商模板" clearable class="w-full mb-2"
                  ...
                  <el-option v-for="item in rtspTemplates" :key="item.manufacturer"
                    :label="`${item.manufacturer} (${item.version})`" :value="item.rtspTemplate">
