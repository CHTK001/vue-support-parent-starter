...
<template>
  <div>
    <el-dialog v-model="visible" top="10px" :close-on-click-modal="false" :close-on-press-escape="false" draggable
        ...
        <el-row :gutter="30">
          ...
          <re-col>
            <el-form-item label="上级菜单">
              <el-cascader v-model="form.sysMenuPid" class="w-full" :options="tableData" :props="props" clearable
          ...
          <re-col v-if="form.sysMenuType !== 3" :value="12" :xs="24" :sm="24">
            <el-form-item label="菜单名称i18n" prop="sysMenuI18n">
              <el-input v-model="form.sysMenuI18n" clearable placeholder="请输入菜单名称i18n" :maxlength="50"
                show-word-limit />
            </el-form-item>
          </re-col>
          <re-col v-if="form.sysMenuType !== 3" :value="12" :xs="24" :sm="24">
          ...
          <re-col v-show="form.sysMenuType === 0" :value="12" :xs="24" :sm="24">
            <el-form-item label="组件路径" prop="sysMenuComponent">
              <el-input v-model="form.sysMenuComponent" clearable placeholder="请输入组件路径" :maxlength="200"
                show-word-limit />
            </el-form-item>
          </re-col>
          ...
          <re-col :value="12" :xs="24" :sm="24">
            <el-form-item label="菜单排序">
              <el-input-number v-model="form.sysMenuSort" class="!w-full" :min="1" :max="9999"
                controls-position="right" />
            </el-form-item>
          </re-col>
          <re-col v-show="form.sysMenuType === 0" :value="12" :xs="24" :sm="24">
            <el-form-item label="路由重定向">
              <el-input v-model="form.sysMenuRedirect" clearable placeholder="请输入默认跳转地址" :maxlength="200"
                show-word-limit />
            </el-form-item>
          </re-col>
          ...
          <re-col v-show="form.sysMenuType !== 3" :value="12" :xs="24" :sm="24">
            <el-form-item label="右侧图标">
              <el-input v-model="form.sysMenuRedirect" clearable placeholder="菜单名称右侧的额外图标" :maxlength="200"
                show-word-limit />
            </el-form-item>
          </re-col>
          ...
          <re-col v-show="form.sysMenuType === 0" :value="12" :xs="24" :sm="24">
            <el-form-item label="菜单激活">
              <el-input v-model="form.sysMenuActivePath" clearable placeholder="请输入需要激活的菜单" :maxlength="200"
                show-word-limit />
            </el-form-item>
          </re-col>
          <re-col v-if="form.sysMenuType === 3" :value="12" :xs="24" :sm="24">
          ...
          <re-col v-show="form.sysMenuType === 1" :value="12" :xs="24" :sm="24">
            ...
            <el-form-item label="链接地址">
              <el-input v-model="form.sysMenuFrameSrc" clearable placeholder="请输入 iframe 链接地址" :maxlength="240"
                show-word-limit />
            </el-form-item>
          </re-col>
          ...
          <re-col v-show="form.sysMenuType !== 3" :value="12" :xs="24" :sm="24">
            <el-form-item label="菜单">
              <Segmented :modelValue="form.sysMenuHidden ? 1 : 0" :options="showLinkOptions" @change="({ option: { value } }) => {
          ...
          <re-col v-show="form.sysMenuType !== 3" :value="12" :xs="24" :sm="24">
            <el-form-item label="父级菜单">
              <Segmented :modelValue="form.sysMenuShowParent ? 0 : 1" :options="showParentOptions" @change="({ option: { value } }) => {
          ...
          <re-col v-show="form.sysMenuType < 2" :value="12" :xs="24" :sm="24">
            <el-form-item label="缓存页面">
              <Segmented :modelValue="form.sysMenuKeepAlive ? 0 : 1" :options="keepAliveOptions" @change="({ option: { value } }) => {
          ...
          <re-col v-show="form.sysMenuType < 2" :value="12" :xs="24" :sm="24">
            <el-form-item label="标签页">
              <Segmented :modelValue="form.sysMenuHiddenTag ? 1 : 0" :options="hiddenTagOptions" @change="({ option: { value } }) => {
          ...
          <re-col v-show="form.sysMenuType < 2" :value="12" :xs="24" :sm="24">
            <el-form-item label="固定标签页">
              <Segmented :modelValue="form.sysMenuFixedTag ? 0 : 1" :options="fixedTagOptions" @change="({ option: { value } }) => {
          ...
          <re-col :value="12" :xs="24" :sm="24">
            <el-form-item label="所属角色">
              <el-select v-model="dynamicTags" multiple>
                <el-option v-for="item in roleOptions" :key="item.sysRoleId" :value="item.sysRoleCode"
