 ...
 * 项目短信日志列表
 */
export const fetchPageProjectForSmsLog = (params) => {
  return http.request<ReturnResult<object[]>>(
    "get",
    "/v2/project/template/sms/log/page",
    {
      params,
    },
  );
...
export const fetchSyncProjectForSms = (params) => {
  return http.request<ReturnResult<object[]>>(
    "put",
    "/v2/project/template/sms/syncTemplate",
    {
      data: params,
    },
  );
...
export const fetchDeleteProjectForSms = (params) => {
  return http.request<ReturnResult<object[]>>(
    "put",
    "/v2/project/template/sms/delete",
    {
      data: params,
    },
  );
...
export const fetchUpdateProjectForSms = (params) => {
  return http.request<ReturnResult<object[]>>(
    "put",
    "/v2/project/template/sms/update",
    {
      data: params,
    },
  );
