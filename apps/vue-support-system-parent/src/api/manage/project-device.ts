...
export const fetchPageProjectForDeviceLog = (params) => {
  return http.request<ReturnResult<object[]>>(
    "get",
    "/v2/project/template/device/log/page",
    {
      params,
    },
  );
...
export const fetchPageProjectForDevice = (params) => {
  return http.request<ReturnResult<object[]>>(
    "get",
    "/v2/project/template/device/page",
    {
      params,
    },
  );
...
export const fetchSyncProjectForDevice = (params) => {
  return http.request<ReturnResult<object[]>>(
    "put",
    "/v2/project/template/device/syncTemplate",
    {
      data: params,
    },
  );
...
export const fetchGetProjectForDevicePreviewUrl = (params) => {
  return http.request<ReturnResult<object[]>>(
    "put",
    "/v2/project/template/device/previewUrl",
    {
      data: params,
    },
  );
...
export const fetchTimelineProjectForDevice = (params) => {
  return http.request<ReturnResult<object[]>>(
    "get",
    "/v2/project/template/device/timeline",
    {
      params,
    },
  );
...
export const fetchCheckProjectForDevice = (params) => {
  return http.request<ReturnResult<object[]>>(
    "put",
    "/v2/project/template/device/check",
    {
      data: params,
    },
  );
...
export const fetchListProjectOrgForDevice = (params) => {
  return http.request<ReturnResult<object[]>>(
    "get",
    "/v2/project/template/device/listOrg",
    {
      params,
    },
  );
...
export const fetchSyncProjectForDeviceOrg = (params) => {
  return http.request<ReturnResult<object[]>>(
    "put",
    "/v2/project/template/device/syncOrg",
    {
      data: params,
    },
  );
...
export const fetchDeleteProjectForDevice = (params) => {
  return http.request<ReturnResult<object[]>>(
    "put",
    "/v2/project/template/device/delete",
    {
      data: params,
    },
  );
...
export const fetchUpdateProjectForDevice = (params) => {
  return http.request<ReturnResult<object[]>>(
    "put",
    "/v2/project/template/device/update",
    {
      data: params,
    },
  );
...
export const fetchSaveProjectForDevice = (params) => {
  return http.request<ReturnResult<object[]>>(
    "post",
    "/v2/project/template/device/save",
    {
      data: params,
    },
  );
