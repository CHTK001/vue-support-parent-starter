...
export const fetchAlertPushTemplatePage = (params: any) => {
  ...
  return http.request<ReturnResult<any>>(
    "get",
    "/v1/gen/server/alert/push-template/page",
    {
      params: query,
    },
  );
...
export const fetchAlertPushTemplateSave = (data: any) => {
  return http.request<ReturnResult<boolean>>(
    "post",
    "/v1/gen/server/alert/push-template",
    { data },
  );
};
...
export const fetchAlertPushTemplateDelete = (id: number) => {
  return http.request<ReturnResult<boolean>>(
    "delete",
    `/v1/gen/server/alert/push-template/${id}`,
  );
};
...
export const fetchAlertPushTemplateTestSend = (
  ...
  return http.request<ReturnResult<boolean>>(
    "post",
    `/v1/gen/server/alert/push-template-test/send/${templateId}`,
    { params },
  );
};
