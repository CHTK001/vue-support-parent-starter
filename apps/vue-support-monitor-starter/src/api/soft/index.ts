...
export function getSoftVersionPageList(params: any) {
  return http.request<ReturnResult<{ records: any[]; total: number }>>("get", "v1/soft/version/page", { params });
}

export function saveSoftVersion(data: any) {
  return http.request<ReturnResult<any>>("post", "v1/soft/version/save", { data });
}
