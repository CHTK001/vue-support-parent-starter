...
export function getSpiderTaskById(id: number) {
  return http.request<ReturnResult<SpiderTask>>("get", `v1/spider/${id}`);
}
...
export function createSpiderTask(data: SpiderTask) {
  return http.request<ReturnResult<SpiderTask>>("post", "v1/spider/save", {
    data,
  });
}
...
export function updateSpiderTask(data: SpiderTask) {
  return http.request<ReturnResult<boolean>>("put", "v1/spider/update", {
    data,
  });
}
...
export function deleteSpiderTask(id: number) {
  return http.request<ReturnResult<boolean>>("delete", `v1/spider/delete`, {
...
export function previewUrl(url: string) {
  return http.request<
    ReturnResult<{ html: string; title: string; baseUrl: string }>
  >("get", "v1/spider/preview", { params: { url } });
}
...
export function runSpiderTask(id: number) {
  return http.request<ReturnResult<boolean>>("post", `v1/spider/run/${id}`);
}
...
export function stopSpiderTask(id: number) {
  return http.request<ReturnResult<boolean>>("post", `v1/spider/stop/${id}`);
}
...
export function getSpiderTaskStatus(id: number) {
  ...
  >("get", `v1/spider/status/${id}`);
}

/**
 * 获取爬虫任务日志
 */
export function getSpiderTaskLogs(
  id: number,
  page: number = 1,
  size: number = 20,
) {
 ...
 * 获取爬取的数据
 */
export function getSpiderTaskData(
  id: number,
  page: number = 1,
  size: number = 20,
) {
...
export function exportSpiderTaskData(id: number, format: string = "json") {
  return http.request<ReturnResult<string>>("get", `v1/spider/export/${id}`, {
    params: { format },
  });
}
...
export function clearSpiderTaskData(id: number) {
  return http.request<ReturnResult<boolean>>("delete", `v1/spider/data/${id}`);
}
...
export function batchRunTasks(taskIds: number[]) {
  return http.request<
    ReturnResult<{ success: number; failed: number; errors: string[] }>
  >("post", "v1/spider/batch/run", { data: { taskIds } });
}
...
export function batchDeleteTasks(taskIds: number[]) {
  return http.request<
    ReturnResult<{ success: number; failed: number; errors: string[] }>
  >("delete", "v1/spider/batch/delete", { data: { taskIds } });
}
...
export function validateSpiConfig(
  ...
  return http.request<ReturnResult<boolean>>("post", "v1/spider/spi/validate", {
    params: { spiType, spiName },
    data: config,
  });
}
 ...
 * 测试SPI配置
 */
export function testSpiConfig(
  spiType: string,
  spiName: string,
  config: Record<string, any>,
) {
  return http.request<ReturnResult<string>>("post", "v1/spider/spi/test", {
    params: { spiType, spiName },
    data: config,
  });
}
