...
export const fetchPrometheusListConfig = (params: any) => {
  return http.request<ReturnResult<MonitorSysGenPrometheusConfig[]>>(
    "get",
    "/v2/prometheus/config/list",
    { params },
  );
};
/**
 ...
 * 保存prometheus配置
 */
export const fetchPrometheusSaveConfig = (
  params: MonitorSysGenPrometheusConfig,
) => {
  return http.request<ReturnResult<boolean>>(
    "post",
    "/v2/prometheus/config/save",
    { data: params },
  );
};
 ...
 * 更新prometheus配置
 */
export const fetchPrometheusUpdateConfig = (
  params: MonitorSysGenPrometheusConfig,
) => {
  return http.request<ReturnResult<boolean>>(
    "put",
    "/v2/prometheus/config/update",
    { data: params },
  );
};
 ...
 * 删除prometheus配置
 */
export const fetchPrometheusDeleteConfig = (
  params: MonitorSysGenPrometheusConfig,
) => {
  return http.request<ReturnResult<boolean>>(
    "delete",
    "/v2/prometheus/config/delete",
    { params },
  );
};
