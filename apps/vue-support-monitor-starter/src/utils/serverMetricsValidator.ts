...
export function normalizeServerMetricsData(rawData: any): ServerMetricsData {
  ...
  return {
    ...
    collectTime: safeString(
      rawData.collectTime ||
        rawData.monitorSysGenServerMetricsCollectTime ||
    ...
    cpu: {
      usage: safeNumber(
        rawData.cpuUsage ||
          rawData.monitorSysGenServerMetricsCpuUsage ||
          (rawData.cpu && rawData.cpu.usage),
      ),
      cores: safeNumber(
        rawData.cpuCores ||
          rawData.monitorSysGenServerMetricsCpuCores ||
          (rawData.cpu && rawData.cpu.cores),
        1,
      ),
      load1m: safeNumber(
        rawData.cpuLoad1m ||
          rawData.monitorSysGenServerMetricsCpuLoad1m ||
          (rawData.cpu && rawData.cpu.load1m),
      ),
      load5m: safeNumber(
        rawData.cpuLoad5m ||
          rawData.monitorSysGenServerMetricsCpuLoad5m ||
          (rawData.cpu && rawData.cpu.load5m),
      ),
      load15m: safeNumber(
        rawData.cpuLoad15m ||
          rawData.monitorSysGenServerMetricsCpuLoad15m ||
          (rawData.cpu && rawData.cpu.load15m),
      ),
    },
    memory: {
      total: safeNumber(
        rawData.memoryTotal ||
          rawData.monitorSysGenServerMetricsMemoryTotal ||
          (rawData.memory && rawData.memory.total),
      ),
      used: safeNumber(
        rawData.memoryUsed ||
          rawData.monitorSysGenServerMetricsMemoryUsed ||
          (rawData.memory && rawData.memory.used),
      ),
      free: safeNumber(
        rawData.memoryFree ||
          rawData.monitorSysGenServerMetricsMemoryFree ||
          (rawData.memory && rawData.memory.free),
      ),
      usage: safeNumber(
        rawData.memoryUsage ||
          rawData.monitorSysGenServerMetricsMemoryUsage ||
          (rawData.memory && rawData.memory.usage),
      ),
    },
    disk: {
      total: safeNumber(
        rawData.diskTotal ||
          rawData.monitorSysGenServerMetricsDiskTotal ||
          (rawData.disk && rawData.disk.total),
      ),
      used: safeNumber(
        rawData.diskUsed ||
          rawData.monitorSysGenServerMetricsDiskUsed ||
          (rawData.disk && rawData.disk.used),
      ),
      free: safeNumber(
        rawData.diskFree ||
          rawData.monitorSysGenServerMetricsDiskFree ||
          (rawData.disk && rawData.disk.free),
      ),
      usage: safeNumber(
        rawData.diskUsage ||
          rawData.monitorSysGenServerMetricsDiskUsage ||
          (rawData.disk && rawData.disk.usage),
      ),
    },
    network: {
      in: safeNumber(
        rawData.networkIn ||
          rawData.monitorSysGenServerMetricsNetworkIn ||
          (rawData.network && rawData.network.in),
      ),
      out: safeNumber(
        rawData.networkOut ||
          rawData.monitorSysGenServerMetricsNetworkOut ||
          (rawData.network && rawData.network.out),
      ),
    },
    osInfo: safeString(
      rawData.osInfo || rawData.monitorSysGenServerMetricsOsInfo,
    ),
    uptime: safeNumber(
      rawData.uptime || rawData.monitorSysGenServerMetricsUptime,
    ),
    processCount: safeNumber(
      rawData.processCount || rawData.monitorSysGenServerMetricsProcessCount,
    ),
    extraInfo: safeString(
      rawData.extraInfo || rawData.monitorSysGenServerMetricsExtraInfo,
    ),
  };
}
