...
!(function (t, i) {
  ...
  (function (t, i) {
    ...
    i.length;
    return function (e) {
      if (("string" == typeof e && (e = document.querySelector(e)), !(e && "object" == typeof e && e.nodeType))) return;
      ...
      let p = t(n.height);
      return !1 !== p && (o.height = p + (s ? 0 : h + l)), (o.innerWidth = o.width - (r + u)), (o.innerHeight = o.height - (h + l)), (o.outerWidth = o.width + a), (o.outerHeight = o.height + d), o;
    };
  }),
  (function (t, i) {
    "object" == typeof module && module.exports ? (module.exports = i()) : (t.EvEmitter = i());
   ...
   */
  (function (t, i) {
    "object" == typeof module && module.exports ? (module.exports = i(t, require("ev-emitter"))) : (t.Unidragger = i(t, t.EvEmitter));
    ...
    (s.handleEvent = function (t) {
      ...
      "ontouchstart" in t
        ...
        : t.PointerEvent
          ? ((n = "pointerdown"), (o = ["pointermove", "pointerup", "pointercancel"]))
      ...
      (s._bindHandles = function (i, e) {
        this.handles.forEach(o => {
          o[i](n, this), o[i]("click", this), t.PointerEvent && (o.style.touchAction = e);
        });
      }),
      ...
      (s.withTouch = function (t, i) {
        let e;
        for (let t of i.changedTouches) t.identifier == this.pointerIdentifier && (e = t);
        e && this[t](i, e);
      }),
    ...
    return (
      ...
      (s.pointerMove = function (t, i) {
        let e = { x: i.pageX - this.pointerDownPointer.pageX, y: i.pageY - this.pointerDownPointer.pageY };
        this.emitEvent("pointerMove", [t, i, e]), !this.isDragging && this.hasDragStarted(e) && this.dragStart(t, i), this.isDragging && this.dragMove(t, i, e);
      }),
      (s.hasDragStarted = function (t) {
        return Math.abs(t.x) > 3 || Math.abs(t.y) > 3;
      }),
      (s.dragStart = function (t, i) {
        (this.isDragging = !0), (this.isPreventingClicks = !0), this.emitEvent("dragStart", [t, i]);
      }),
      ...
      (s.pointerUp = function (t, i) {
        this.pointerDone(), this.emitEvent("pointerUp", [t, i]), this.isDragging ? this.dragEnd(t, i) : this.staticClick(t, i);
      }),
      (s.dragEnd = function (t, i) {
        (this.isDragging = !1), setTimeout(() => delete this.isPreventingClicks), this.emitEvent("dragEnd", [t, i]);
      }),
  ...
  (function (t, i) {
    ...
    let n = t.jQuery;
    function o(t, i) {
      (this.element = "string" == typeof t ? document.querySelector(t) : t), n && (this.$element = n(this.element)), (this.options = {}), this.option(i), this._create();
    }
    ...
    (s.emitEvent = function (i, e) {
      ...
      (s.measureContainment = function () {
        ...
        let e = i(this.element),
          n = i(t),
          { borderLeftWidth: o, borderRightWidth: s, borderTopWidth: r, borderBottomWidth: h } = n,
          a = this.element.getBoundingClientRect(),
          d = t.getBoundingClientRect(),
          u = o + s,
          l = r + h,
          c = (this.relativeStartPosition = { x: a.left - (d.left + o), y: a.top - (d.top + r) });
        this.containSize = { width: n.width - u - c.x - e.width, height: n.height - l - c.y - e.height };
      }),
      ...
      (s.setLeftTop = function () {
        ...
        (this.element.style.left = `${t}px`), (this.element.style.top = `${i}px`);
      }),
