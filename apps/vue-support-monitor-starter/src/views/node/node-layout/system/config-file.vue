<template>
  <div class="">
    <a-form ref="editForm" :model="temp">
      <a-form-item>
        <code-editor v-model:content="temp.content" height="calc(100vh - 200px)" :options="{ mode: 'yaml', tabSize: 2 }" :show-tool="true">
      ...
      <a-form-item :wrapper-col="{ span: 14, offset: 2 }">
        <a-space>
          <a-button type="primary" :disabled="submitAble" @click="onSubmit(false)">{{ $t("i18n_be5fbbe34c") }}</a-button>
          <a-button type="primary" danger :disabled="submitAble" @click="onSubmit(true)">{{ $t("i18n_6aab88d6a3") }}</a-button>
        </a-space>
      </a-form-item>
    </a-form>
  </div>
