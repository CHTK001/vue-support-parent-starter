<template>
  <div class="console" :style="gridStyle">
    <div class="left overflow-auto thin-scrollbar" @contextmenu.prevent>
      ...
      <el-tree class="tree" :data="treeData" :props="treeProps" :load="loadChildrenLazy" lazy node-key="path" :expand-on-click-node="false" @node-click="handleNodeClick">
    ...
    <div class="right image-paper">
      <div class="right-header">
        ...
        <div class="toolbar">
          <el-select v-model="version" size="small" class="mr-2" style="width: 100px">
      ...
      <div class="right-body">
        <CodeEditor v-model:content="flux" :showTool="false" :height="'200px'" :options="{ mode: 'flux' }" />
...
import { getConsoleRoot, getConsoleChildren, executeConsole } from "@/api/system-data";
...
async function execute() {
  ...
  const res = await executeConsole(props.id, flux.value, "influx", { influxVersion: version.value });
