        ...
        <el-container v-else>
          <el-header>
            <div class="left-panel">
              <el-input v-model="searchQuery" placeholder="请输入过滤条件" @input="handleSearch" />
            </div>
          </el-header>
          <el-main class="nopadding" style="height: 500px; overflow: auto">
            <el-table :data="filteredData" stripe height="470" :filter-method="filterHandler" :default-sort="{ prop: 'bytes', order: 'descending' }">
