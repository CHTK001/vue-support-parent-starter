          ...
          <a-space>
            ...
            <template v-if="project.runMode === 'Dsl'">
              ...
              <template v-else>
                <a-button 
                  ...
                  :loading="optButtonLoading" 
                  type="primary"
                  class="action-button reload-button disabled"
                >
                  <template #icon><SyncOutlined /></template>
                  {{ $t('i18n_aaeb54633e') }}
                </a-button>
            ...
            <a-dropdown v-if="project.dslProcessInfo" class="process-dropdown">
                  ...
                  <a-menu-item v-for="(item, index) in project.dslProcessInfo" :key="index" class="process-item">
                    <template v-if="item.status">
                      ...
                      <template v-else-if="item.type === 'library'">
                        <a-button type="link" size="small" disabled class="library-button">
                          {{ $t('i18n_91a10b8776') }}{{ item.scriptId }}
                        </a-button>
                      </template>
                    </template>
                    <template v-else>
              ...
              <a-button size="small" type="primary" class="process-button">
                ...
                {{ $t('i18n_ce40cd6390') }} <DownOutlined />
              </a-button>
            </a-dropdown>
            ...
            >
              ...
              {{ $t('i18n_76aebf3cc6') }}: <span class="log-size">{{ project.logSize || '-' }}</span>
