...
import BuildList from '@/views/maintenance/build/list-info'
import BuildHistory from '@/views/maintenance/build/history'
import FileStorage from '@/views/maintenance/file-manager/fileStorage/list'
import StaticFileStorage from '@/views/maintenance/file-manager/staticFileStorage/list'
