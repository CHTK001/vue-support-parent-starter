...
import BuildList from '@/views/maintenance/build/list-info.vue'
import BuildHistory from '@/views/maintenance/build/history.vue'
import FileStorage from '@/views/maintenance/file-manager/fileStorage/list.vue'
import StaticFileStorage from '@/views/maintenance/file-manager/staticFileStorage/list.vue'
