...
const loadData = async () => {
  try {
    ...
    const params = {
      ...
      fileName: searchQuery.fileName || undefined,
      fileStatus: searchQuery.fileStatus || undefined,
    };

    const res = await getFileSystemPage(params);
