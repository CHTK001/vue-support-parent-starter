<template>
  <div class="pie-preview" :class="{ 'edit-mode': editMode }">
    <div class="card-header">
      <div class="card-title">
        <IconifyIconOnline icon="ri:pie-chart-line" class="card-icon" />
  ...
  try {
    ...
    if (res.code === "00000") {
      ...
      if (res.data && Array.isArray(res.data)) {
        ...
        // 如果没有数据，生成模拟数据用于演示
        const categories = ['系统进程', '用户进程', '服务进程', '后台进程', '其他进程'];
        chartData = categories.map(name => ({
