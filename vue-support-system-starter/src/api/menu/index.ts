...
export function listRoutes() {
  return request({
    url: Global.HOST + '/api/v1/menus/routes',
    method: 'get'
  });
}
...
export function listMenuOptions(): AxiosPromise<OptionType[]> {
  return request({
    url: Global.HOST + '/api/v1/menus/options',
    method: 'get'
  });
}
...
export function getMenuForm(id: number): AxiosPromise<MenuForm> {
  return request({
    url: Global.HOST + '/api/v1/menus/' + id + '/form',
    method: 'get'
  });
}
...
export function updateMenu(id: string, data: MenuForm) {
  return request({
    url: Global.HOST + '/api/v1/menus/' + id,
    method: 'put',
    data: data
  });
}
