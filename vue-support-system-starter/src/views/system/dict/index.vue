...
import {DictTypeForm, DictTypePageVO, DictTypeQuery} from "@/api/dict/types";
...
function handleSubmit() {
  ...
  dataFormRef.value.validate((isValid: boolean) => {
    if (isValid) {
      const dictTypeId = formData.dictTypeId;
      if (dictTypeId) {
...
function resetForm() {
  ...
  formData.dictTypeId = undefined;
  formData.dictTypeStatus = 1;
}
...
function openDictDialog(row: DictTypePageVO) {
  ...
  dictDataDialog.title = "【" + row.dictTypeName + "】字典数据";

  selectedDictType.typeCode = row.dictTypeCode;
  selectedDictType.typeName = row.dictTypeName;
}
  ...
  <div class="app-container">
    <div class="search">
      <el-form ref="queryFormRef" :model="queryParams" :inline="true">
        <el-form-item label="关键字" prop="dictTypeName">
          <el-input
    ...
    <el-card shadow="never">
      ...
      >
        ...
        <el-table-column label="字典类型名称" prop="dictTypeName" width="200" />
        <el-table-column label="字典类型编码" prop="dictTypeCode" width="200" />
        <el-table-column label="状态" align="center" width="100">
          <template #default="scope">
            <el-tag v-if="scope.row.dictTypeStatus === 1" type="success">启用</el-tag>
            <el-tag v-else type="info">禁用</el-tag>
          </template>
        </el-table-column>
        <el-table-column label="备注" prop="dictTypeRemark" align="center" />
        <el-table-column fixed="right" label="操作" align="center" width="220">
          <template #default="scope">
            ...
            <el-button
              ...
              link
              size="small"
              @click.stop="openDialog(scope.row.dictTypeId)"
            ...
            <el-button
              ...
              link
              size="small"
              @click.stop="handleDelete(scope.row.dictTypeId)"
    ...
    >
      ...
      >
        <el-form-item label="字典名称" prop="dictTypeName">
          <el-input v-model="formData.dictTypeName" placeholder="请输入字典名称" />
        </el-form-item>
        <el-form-item label="字典编码" prop="dictTypeCode">
          <el-input v-model="formData.dictTypeCode" placeholder="请输入字典编码" />
        </el-form-item>
        <el-form-item label="状态" prop="dictTypeStatus">
          <el-radio-group v-model="formData.dictTypeStatus">
        ...
        <el-form-item label="备注" prop="dictTypeRemark">
          <el-input
            v-model="formData.dictTypeRemark"
            type="textarea"
            placeholder="字典类型备注"
