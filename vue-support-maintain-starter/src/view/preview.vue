<template>
  <div style="position: relative;">
    ...
    <div v-else>
      ...
      <div class="preview excel" v-if="subtype === 'vnd.ms-excel' || subtype === 'csv' || subtype === 'vnd.openxmlformats-officedocument.spreadsheetml.sheet' ||subtype === 'vnd.ms-excel.sheet.macroenabled.12' ">
...
import ExcelLayout from '@/view/subview/excel-layout.vue'
