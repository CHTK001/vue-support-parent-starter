...
export const fetchPageProjectForEmailLog = (params) => {
  return http.request<ReturnResult<object[]>>(
    "get",
    "/v2/project/template/email/log/page",
    {
      params,
    },
  );
...
export const fetchPageProjectForEmail = (params) => {
  return http.request<ReturnResult<object[]>>(
    "get",
    "/v2/project/template/email/page",
    {
      params,
    },
  );
...
export const fetchSyncProjectForEmail = (params) => {
  return http.request<ReturnResult<object[]>>(
    "put",
    "/v2/project/template/email/syncTemplate",
    {
      data: params,
    },
  );
...
export const fetchDeleteProjectForEmail = (params) => {
  return http.request<ReturnResult<object[]>>(
    "put",
    "/v2/project/template/email/delete",
    {
      data: params,
    },
  );
...
export const fetchUpdateProjectForEmail = (params) => {
  return http.request<ReturnResult<object[]>>(
    "put",
    "/v2/project/template/email/update",
    {
      data: params,
    },
  );
...
export const fetchSaveProjectForEmail = (params) => {
  return http.request<ReturnResult<object[]>>(
    "post",
    "/v2/project/template/email/save",
    {
      data: params,
    },
  );
