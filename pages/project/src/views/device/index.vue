                ...
                <template #reference>
                  <div class="flex flex-row justify-between relative">
                    ...
                    <div class="flex justify-center items-center text-[18px]">
                      ...
                      <IconifyIconOnline v-if="row.sysDeviceResourceType == 'CAMERA'" class="cursor-pointer" title="预览" icon="mingcute:computer-camera-fill" @click="deviceInstance.handlePreviewUrl(cameraPreviewDialogRef, row, 'view')" />
