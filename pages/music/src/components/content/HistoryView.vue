...
<template>
  <div class="history-view">
    <div class="history-view__header">
      ...
      <div class="history-view__count">
        共 {{ env.playHistory.length }} 首歌曲
      </div>
    </div>
    ...
    <div class="history-view__empty" v-if="!env.playHistory.length">
      <IconifyIconOnline
        ...
        class="history-view__empty-icon"
      />
    ...
    <div class="history-view__music-list" v-else>
      <div
        ...
        :class="{
          'history-view__music-item--active':
      ...
      >
        ...
        <div class="history-view__music-duration">
