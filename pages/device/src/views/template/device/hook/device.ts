...
import { fetchCheckProjectForDevice, fetchDeleteProjectForDevice, fetchSyncProjectForDevice, fetchSyncProjectForDeviceOrg, fetchUpdateProjectForDevice } from "../../../../api/manage/device-template";
/**
 * 创建一个新的 Device 实例。
 *
