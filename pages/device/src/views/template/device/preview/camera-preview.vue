...
import { fetchGetProjectForDevicePreviewUrl } from "../../../../api/manage/device-template";
...
.device-camera-settings-toggle {
  ...
  &:hover {
    ...
    animation:
      device-camera-float 3s ease-in-out infinite,
      device-camera-breathe 2s ease-in-out infinite;
  }
}
