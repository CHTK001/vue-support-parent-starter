            ...
            <el-form label-position="top" size="default">
              ...
              <el-form-item label="功能控制">
                <div class="control-options">
                  ...
                  <el-checkbox v-model="overviewControl">启用鹰眼</el-checkbox>
                </div>
              </el-form-item>

              <el-form-item label="鹰眼配置" v-if="overviewControl">
                <div class="overview-config">
                  <el-form-item label="鹰眼位置" size="small">
                    <el-radio-group v-model="overviewOptions.position" size="small">
                  ...
                  <div class="overview-colors mt-2">
                    ...
                    <el-form-item label="视野矩形边框色" size="small">
                      <el-color-picker v-model="overviewOptions.rectStrokeColor" size="small"></el-color-picker>
                    </el-form-item>
                  </div>
                </div>
              </el-form-item>
...
// 在配置选项中添加鹰眼相关选项
const overviewControl = ref(false); // 鹰眼控制状态
...
const toggleOverview = () => {
  overviewControl.value = !overviewControl.value;
  ElMessage.success(overviewControl.value ? '鹰眼已开启' : '鹰眼已关闭');
};

// 鹰眼事件处理函数
const onOverviewToggle = (expanded) => {
  console.log('鹰眼展开/折叠状态变更:', expanded);
};
...
.overview-size-controls {
  display: flex;
  justify-content: space-between;
  margin-bottom: 10px;
}

.overview-size-controls .el-form-item {
  margin-bottom: 5px;
  margin-right: 10px;
}
