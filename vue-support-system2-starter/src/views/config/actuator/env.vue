...
a.box:focus,a.box:hover {
    -webkit-box-shadow: 0 .5em 1em -.125em rgba(10,10,10,.1),0 0 0 1px #42d3a5;
    box-shadow: 0 .5em 1em -.125em rgba(10,10,10,.1),0 0 0 1px #42d3a5
}

a.box:active {
    -webkit-box-shadow: inset 0 1px 2px rgba(10,10,10,.2),0 0 0 1px #42d3a5;
    box-shadow: inset 0 1px 2px rgba(10,10,10,.2),0 0 0 1px #42d3a5
}
...
.button.is-focused:not(:active),.button:focus:not(:active) {
    -webkit-box-shadow: 0 0 0 .125em rgba(66,211,165,.25);
    box-shadow: 0 0 0 .125em rgba(66,211,165,.25)
}
...
.file.is-primary.is-focused .file-cta,.file.is-primary:focus .file-cta {
    border-color: transparent;
    -webkit-box-shadow: 0 0 .5em rgba(66,211,165,.25);
    box-shadow: 0 0 .5em rgba(66,211,165,.25);
    color: #fff
}
...
.has-text-primary-dark {
    color: #1c785b!important
}

a.has-text-primary-dark:focus,a.has-text-primary-dark:hover {
    color: #26a17a!important
}

.has-background-primary-dark {
    background-color: #1c785b!important
}
...
.hero.is-primary.is-bold {
    background-image: linear-gradient(141deg,#1fc374,#42d3a5 71%,#51ddc8)
}
...
.navbar .has-badge[data-badge]:after {
    -webkit-box-shadow: 0 0 0 1px #242424;
    box-shadow: 0 0 0 1px #242424
}

.content.is-loading:after,.section.is-loading:after {
...
.content.is-loading:after,.section.is-loading:after,p.is-loading:before {
