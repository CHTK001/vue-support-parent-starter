/* tslint:disable */
/* eslint-disable */
export function custom_encrypt_with_codec_keypair(
  data: string,
  pubkey: string,
  privkey: string,
): string;
...
export function uu1_decrypt_response_object_with_arraybuffer(
  response: any,
): any;
 ...
 */
export function decrypt_storage_value(
  value: string,
  key: string,
  system: string,
  storage_key: string,
 ...
 */
export function encrypt_storage_value(
  value: string,
  key: string,
  system: string,
  storage_key: string,
...
export function uu4_decrypt_response(
  data: string,
  _uuid: string,
  ts: string,
): string;
...
export function uu1_decrypt_response(
  data: string,
  _origin: string,
  ts: string,
): string;
 ...
 * 字体加密文本
 */
export function font_encrypt_text(
  text: string,
  encrypt_numbers: boolean,
  encrypt_chinese: boolean,
): string;
/**
 * 生成随机 nonce 字符串
 */
...
export interface InitOutput {
  ...
  readonly custom_encrypt_with_codec_keypair: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly decrypt_storage_value: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly encrypt_storage_key: (
    a: number,
    b: number,
    c: number,
    d: number,
  ) => [number, number];
  readonly encrypt_storage_value: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly sm2_decrypt: (
    a: number,
    b: number,
    c: number,
    d: number,
  ) => [number, number];
  readonly sm2_encrypt: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly sm4_decrypt: (
    a: number,
    b: number,
    c: number,
    d: number,
  ) => [number, number];
  readonly sm4_encrypt: (
    a: number,
    b: number,
    c: number,
    d: number,
  ) => [number, number];
  readonly uu1_decrypt_response: (
    a: number,
    b: number,
    c: number,
    d: number,
