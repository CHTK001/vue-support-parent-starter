...
export function encrypt_storage_key(key_ptr: number, key_len: number, system_code_ptr: number, system_code_len: number): number;
export function encrypt_storage_value(value_ptr: number, value_len: number, key_ptr: number, key_len: number, system_code_ptr: number, system_code_len: number, storage_key_ptr: number, storage_key_len: number, storage_encode_ptr: number, storage_encode_len: number): number;
export function decrypt_storage_value(value_ptr: number, value_len: number, key_ptr: number, key_len: number, system_code_ptr: number, system_code_len: number, storage_key_ptr: number, storage_key_len: number, storage_encode_ptr: number, storage_encode_len: number): number;
