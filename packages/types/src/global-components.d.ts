declare module "vue" {
  ...
  export interface GlobalComponents {
    IconifyIconOffline: (typeof import("@repo/components/ReIcon"))["IconifyIconOffline"];
    IconifyIconOnline: (typeof import("@repo/components/ReIcon"))["IconifyIconOnline"];
    FontIcon: (typeof import("@repo/components/ReIcon"))["FontIcon"];
    Auth: (typeof import("@repo/components/ReAuth"))["Auth"];
  }
}
