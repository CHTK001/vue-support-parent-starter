...
import MusicHeader from './music/components/MusicHeader.vue';
import MusicSidebar from './music/components/MusicSidebar.vue';
import MusicPlayer from './music/components/MusicPlayer.vue';
import MusicContent from './music/components/MusicContent.vue';
import MusicLyrics from './music/components/MusicLyrics.vue';
import MusicPlaylistDrawer from './music/components/MusicPlaylistDrawer.vue';
import { 
  fetchMusicTypes, 
  fetchMusicPlatforms, 
  fetchHotKeywords, 
