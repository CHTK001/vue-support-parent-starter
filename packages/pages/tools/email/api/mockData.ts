...
export const emailMessages: EmailInfo[] = [
  {
    ...
    emailRecipients: {
      emailTo: [
        { emailName: '工作邮箱', emailAddress: 'work@example.com' }
      ],
      emailCc: [
  ...
  },
  {
    ...
    emailRecipients: {
      ...
      emailCc: [
        { emailName: '共同好友', emailAddress: 'mutual@friend.com' }
      ]
    },
  ...
  },
  {
    ...
    emailRecipients: {
      emailTo: [
        { emailName: '备用邮箱', emailAddress: 'backup@example.com' }
      ]
    },
...
export const emailSentMessages: EmailInfo[] = [
  {
    ...
    emailRecipients: {
      ...
      emailCc: [
        { emailName: '产品经理', emailAddress: 'product@company.com' }
      ]
    },
    emailAttachments: [
      {
  ...
  },
  {
    ...
    emailRecipients: {
      emailTo: [
        { emailName: '李朋友', emailAddress: 'friend@personal.com' }
      ]
    },
...
export const emailDraftMessages: EmailInfo[] = [
  {
    ...
    emailRecipients: {
      emailTo: [
        { emailName: '王总', emailAddress: 'wang@partner.com' }
      ]
    },
    emailAttachments: [
      {
  ...
  },
  {
    ...
    emailRecipients: {
      emailTo: [
        { emailName: '朋友群组', emailAddress: 'friends@group.com' }
      ]
    },
