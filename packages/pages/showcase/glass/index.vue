      ...
      <div class="showcase-header glass-panel">
        <div class="header-content">
          ...
          <p class="page-subtitle">
            A modern, frosted glass interface design for next-gen applications.
          </p>
        </div>
      ...
      <div class="showcase-grid">
          ...
          <div class="cards-grid">
            ...
            >
              ...
              <div
                class="card-trend"
                :class="{
                  'trend-up': card.trend.startsWith('+'),
                  'trend-down': card.trend.startsWith('-'),
                }"
              >
                {{ card.trend }}
              </div>
          ...
          <div class="glass-panel content-padding form-demo">
            <div class="form-group">
              ...
              <ScInput
                ...
                class="glass-input"
                :prefix-icon="useRenderIcon('ep:edit')"
              />
            </div>
            ...
            <div class="form-group">
              ...
              >
                <ScOption label="Glass Theme" value="glass" />
                <ScOption label="Minimal" value="minimal" />
              </ScSelect>
            </div>
            ...
            <div class="form-row">
              <div class="form-group">
                <label>Switch</label>
                <ScSwitch v-model="switchValue" active-text="Active" />
              </div>
              <div class="form-group">
                <label>Slider</label>
            ...
            <div class="form-actions">
              <ScButton class="glass-btn">Cancel</ScButton>
              <ScButton
                type="primary"
                class="glass-btn-primary"
                :loading="loading"
        ...
        <div class="grid-section">
          ...
          <div class="glass-panel content-padding">
            ...
            <p class="text-body">
              This is standard body text. Glassmorphism relies on background
              blur and semi-transparent layers to create depth.
            </p>

            <div class="divider"></div>

            <div class="button-group">
              <ScButton class="glass-btn">Default</ScButton>
              <ScButton type="primary" class="glass-btn-primary"
                >Primary</ScButton
              >
              <ScButton
                type="success"
              ...
              />
              <ScButton type="warning" class="glass-btn-warning" round
                >Warning</ScButton
              >
            </div>

            <div class="mt-4">
              <ScTag class="glass-tag mr-2">Tag One</ScTag>
              <ScTag type="success" class="glass-tag mr-2">Success</ScTag>
              <ScTag type="warning" class="glass-tag">Warning</ScTag>
            </div>
          </div>
        </div>
        ...
        <div class="grid-section full-width">
          ...
          <div class="glass-panel no-padding overflow-hidden">
            <ScTable :data="tableData" style="width: 100%" class="glass-table">
              <ScTableColumn prop="date" label="Date" width="180" />
              <ScTableColumn prop="name" label="Name" width="180" />
              <ScTableColumn prop="type" label="Type" />
              <ScTableColumn prop="status" label="Status">
              ...
              <ScTableColumn label="Operations" width="120">
                <template #default>
                  <ScButton link type="primary" size="small">Edit</ScButton>
                  <ScButton link type="danger" size="small">Delete</ScButton>
                </template>
              </ScTableColumn>
            </ScTable>
          </div>
