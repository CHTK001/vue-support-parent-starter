...
export default [
  ...
  },
  {
    path: "/bindSuccess",
    name: "bindSuccess",
    component: () => import("@pages/system/page/bindSuccess.vue"),
    meta: {
  ...
  },
  {
    ...
    component: () =>
      import("@pages/system/page/remaining/RemainingComponentPage.vue"),
    meta: {
      title: "组件页面",
      showLink: false,
    },
  ...
  },
  {
    path: "/message/center",
    name: "MessageCenter",
    component: () => import("@pages/system/page/message/MessageCenter.vue"),
    meta: {
      title: "消息中心",
      showLink: false,
    },
    ...
    children: [
      {
        path: "/redirect/:path(.*)",
        name: "Redirect",
        component: () => import("@pages/system/layout/redirect.vue"),
      },
    ],
  },
  // 全屏错误页面 - 不在Layout内渲染
  {
    path: "/error/403",
    name: "Error403",
    component: () => import("@pages/system/error/403.vue"),
    meta: {
  ...
  },
  {
    path: "/error/500",
    name: "Error500",
    component: () => import("@pages/system/error/500.vue"),
    meta: {
