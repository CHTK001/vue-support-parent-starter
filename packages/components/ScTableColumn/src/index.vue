...
defineProps({
  type: { type: String as PropType<"selection" | "index" | "expand">, default: undefined },
  index: { type: [Number, Function] as PropType<number | ((index: number) => number)>, default: undefined },
  ...
  sortOrders: { type: Array as PropType<Array<"ascending" | "descending" | null>>, default: () => ["ascending", "descending", null] },
  ...
  headerAlign: { type: String as PropType<"left" | "center" | "right">, default: undefined },
  ...
  filterPlacement: { type: String, default: undefined },
  filterMultiple: { type: Boolean, default: true },
  filterMethod: { type: Function, default: undefined },
  filteredValue: { type: Array, default: undefined }
});
</script>
