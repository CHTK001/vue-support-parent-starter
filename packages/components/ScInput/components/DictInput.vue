<template>
  <ScSelect
    ...
    @clear="handleClear"
  >
    <ScOption v-for="(option, index) in dictList" :key="index" :label="option[dictOptionName]" :value="option[dictOptionId]" />
...
const emit = defineEmits(["update:modelValue", "change", "visible-change", "focus", "blur", "clear"]);
