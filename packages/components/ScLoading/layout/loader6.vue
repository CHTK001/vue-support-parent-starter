    ...
    <div class="shadow-text">
      <div class="text-center inline-block text-white text-14px w-full h-full">
        <div class="relative w-full flex flex-col items-center justify-center h-full">
          <div class="w-full rounded-2.5 flex items-center justify-center shadow-bg-text" style="width: 188px; height: 188px">
            <div data-v-a4c4d738="" class="flex justify-center items-center text-white">
