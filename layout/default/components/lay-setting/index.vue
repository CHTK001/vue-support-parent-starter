    ...
    <div class="p-5">
      ...
      <ul class="setting">
        ...
        <li>
          ...
          <el-switch v-model="logoVal" inline-prompt :active-value="true" :inactive-value="false" :active-text="t('buttons.pureOpenText')" :inactive-text="t('buttons.pureCloseText')" @change="logoChange" />
        </li>
        <li>
          <span class="dark:text-white">内容卡片</span>
          <el-switch v-model="cardBodyVal" inline-prompt :active-value="true" :inactive-value="false" :active-text="t('buttons.pureOpenText')" :inactive-text="t('buttons.pureCloseText')" @change="cardBodyChange" />
        </li>
        <li>
