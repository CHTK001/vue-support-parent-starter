  ...
  <div class="font-encryption-demo">
    ...
    <div class="demo-area">
      <div class="demo-section">
        ...
        >
          ...
          <p>
            这是一段测试文本，包含汉字：这是一个测试，包含常用汉字如：的、了、在、是、我、有、和等。
          </p>
    ...
    <div class="demo-info">
      ...
      <ul>
        ...
        <li>
          <strong>指令方式：</strong>使用
          <code>v-font-encryption</code> 指令，支持动态配置
        </li>
        <li>
          <strong>类名方式：</strong>使用
          <code>font-encryption-enabled</code> 类名，需要手动加密文本
        </li>
        <li><strong>复制开关：</strong>可以禁用复制功能，防止用户复制内容</li>
      </ul>
    </div>
  </div>
</template>
