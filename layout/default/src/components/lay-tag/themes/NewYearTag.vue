...
<template>
  <div v-if="!showTags" ref="containerDom" class="tags-view new-year-tag">
    ...
    >
      <div ref="tabDom" class="tab select-none" :style="getTabStyle">
        <!-- 蓝紫烟花风格标签，不使用 showModel 类名 -->
        <div
          v-for="(item, index) in multiTags"
          :ref="'dynamic' + index"
          :key="index"
          :class="[
            'scroll-item is-closable new-year-item',
            linkIsActive(item),
...
html.theme-spring-festival {
  .tags-view.new-year-tag {
    ...
    box-shadow: 0 6px 18px rgba(76, 0, 0, 0.24) !important;
  }

  .new-year-tag .scroll-item {
