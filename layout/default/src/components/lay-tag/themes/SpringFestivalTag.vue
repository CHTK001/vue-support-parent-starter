...
<template>
  <div v-if="!showTags" ref="containerDom" class="tags-view spring-festival-tag">
    ...
    >
      <div ref="tabDom" class="tab select-none" :style="getTabStyle">
        <!-- 春联风格标签，不使用 showModel 类名 -->
        <div
          v-for="(item, index) in multiTags"
          :ref="'dynamic' + index"
          :key="index"
          :class="[
            'scroll-item is-closable spring-couplet-item',
            linkIsActive(item),
