  ...
  <div>
    ...
    >
      ...
      <el-select v-model="period">
        ...
        <el-option label="每隔10秒刷新" :value="10" />
        <el-option label="每隔20秒刷新" :value="20" />
        <el-option label="每隔30秒刷新" :value="30" />
        <el-option label="每隔40秒刷新" :value="40" />
      </el-select>
      <el-button v-if="intervalRefTimeValue" plain text icon="sc-icon-time">刷新倒计时: {{ intervalRefTimeValue }}秒</el-button>
      <el-divider />
      <redis-layout :data="data" />
    </el-drawer>
  </div>
</template>
