            ...
            <el-row>
                <el-col :span="12">
                    <el-form-item label="任务描述" prop="jobDesc">
                        <el-input placeholder="请输入任务描述" maxlength="50" v-model="form.jobDesc" />
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="负责人" prop="author">
                        <el-input maxlength="50" placeholder="请输入负责人" v-model="form.author" />
                    </el-form-item>
                </el-col>
            </el-row>
            ...
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item label="报警邮件">
                        <el-input maxlength="100" placeholder="请输入报警邮件，多个邮件地址则逗号分隔" v-model="form.alarmEmail" />
                    </el-form-item>
                </el-col>
            </el-row>
            ...
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item label="执行名称" prop="executorHandler">
                        <el-input maxlength="100" v-model="form.executorHandler" placeholder="请输入后端配置执行名称"
                            clearable></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
                <el-col :span="24">
                    <el-form-item label="任务参数" prop="executorParam">
                        <el-input type="textarea" maxlength="512" v-model="form.executorParam" placeholder="请输入任务参数"  clearable></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
            <p>高级配置</p>
            ...
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item label="子任务ID" prop="childJobId">
                        <el-input maxlength="100" v-model="form.childJobId" placeholder="请输入子任务的任务ID,如存在多个则逗号分隔" clearable></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
            ...
            <el-row>
                <el-col :span="12">
                    <el-form-item label="任务超时时间" prop="executorTimeout">
                        <el-input maxlength="6" v-model="form.executorTimeout" placeholder="任务超时时间，单位秒，大于零时生效" clearable onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="失败重试次数" prop="executorFailRetryCount">
                        <el-input maxlength="4" v-model="form.executorFailRetryCount" placeholder="失败重试次数，大于零时生效" clearable onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
        </el-form>
